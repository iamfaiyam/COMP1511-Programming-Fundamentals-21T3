// A C program which inserts a new node containing value at the end of the 
// linked list. The head of the new list is returned
...
struct node *insert_tail(int value, struct node *head) {
    ...
    struct node *number = malloc(sizeof(struct node)), *list; 
